# Keyboards for Uralic languages (FUPA)
...
keyboards for the Uralic languages language. The code
...
The Uralic languages (FUPA) keyboard sources can be acquired using the Fork or Code
